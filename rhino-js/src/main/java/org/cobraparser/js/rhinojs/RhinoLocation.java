...
public class RhinoLocation extends AbstractScriptableDelegate implements Location {
  private static final Logger logger = LoggerFactory.getLogger(RhinoLocation.class.getName());
  private final RhinoWindow window;

  RhinoLocation(final RhinoWindow window) {
    this.window = window;
  }
