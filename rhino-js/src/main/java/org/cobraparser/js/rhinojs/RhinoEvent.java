...
public class RhinoEvent extends AbstractScriptableDelegate implements Event {
  ...
  public RhinoEvent(final String type, final Node srcElement, final InputEvent mouseEvent, final int leafX, final int leafY) {
    this.type = type;
  ...
  public RhinoEvent(final String type, final Node srcElement, final KeyEvent keyEvent) {
    this.type = type;
    this.srcElement = srcElement;
    this.inputEvent = keyEvent;
  }

  public RhinoEvent(final String type, final Node srcElement) {
    this.type = type;
    this.srcElement = srcElement;
